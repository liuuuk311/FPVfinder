...
<div class="bg-gray-900">
	<div class="flex flex-col md:flex-row md:justify-start items-center mb-2 p-2 pb-4 mx-10">
		<a href="/"><div class="my-4 text-2xl font-bold text-white-700 md:text-lg md:pr-5 md:w-32 text-white">FPV Finder</div></a>
