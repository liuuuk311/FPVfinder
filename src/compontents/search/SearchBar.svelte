...
<div class="dark:bg-gray-800">
	<div class="flex flex-col px-2">
		<form on:submit|preventDefault={() => keywords.set(searchedKeywords)} class="w-full md:flex-grow">
			<div class="flex-grow items-center bg-white dark:bg-gray-600 dark:text-gray-100 rounded-full overflow-hidden">
				<input 
					...
					on:input={() => getSuggestions(searchedKeywords)} 
					input="search" 
				...
				<button 
					on:click|preventDefault={() => keywords.set(searchedKeywords)} 
